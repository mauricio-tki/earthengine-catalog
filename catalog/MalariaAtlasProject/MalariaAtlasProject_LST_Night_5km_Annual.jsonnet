local id = 'MalariaAtlasProject/LST_Night_5km_Annual';
...

{
  ...
  id: id,
  title: 'Annual Gapfilled Nighttime Land Surface Temperature 5km from MODIS MOD11A2 v6.1 products',
  ...
  description: |||
    ...
    Annual filenames are formatted as follows:  `LST_Night_v061.{Year}.Annual.mean.5km.mean.tif`  
  |||,
  license: license.id,
