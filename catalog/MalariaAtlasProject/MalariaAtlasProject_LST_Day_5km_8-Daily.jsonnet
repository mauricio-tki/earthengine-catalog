local id = 'MalariaAtlasProject/LST_Day_5km_8-Daily';
...

{
  ...
  id: id,
  title: '8-Daily Gapfilled Daytime Land Surface Temperature 5km from MODIS MOD11A2 v6.1 products',
  ...
  description: |||
    ...
    8-Daily daytime filenames are formatted as follows:  `LST_Day_v061.{Year}.{JulianDay}.Data.5km.mean.tif`  
  |||,
  license: license.id,
