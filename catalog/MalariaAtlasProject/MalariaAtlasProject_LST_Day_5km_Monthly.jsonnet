local id = 'MalariaAtlasProject/LST_Day_5km_Monthly';
...

{
  ...
  id: id,
  title: 'Monthly Gapfilled Daytime Land Surface Temperature 5km from MODIS MOD11A2 v6.1 products',
  ...
  description: |||
    ...
    Monthly daytime filenames are formatted as follows:  `LST_Day_v061.{Year}.{Month}.mean.5km.mean.tif`  
  |||,
  license: license.id,
