local id = 'MalariaAtlasProject/LST_Night_5km_8-Daily';
...

{
  ...
  id: id,
  title: '8-Daily Gapfilled Nighttime Land Surface Temperature 5km from MODIS MOD11A2 v6.1 products',
  ...
  description: |||
    ...
    The gap-filled 8-daily ~1km outputs are then aggregated spatially to produce ~5km products.

    8-Daily nighttime filenames are formatted as follows:  `LST_Night_v061.{Year}.{JulianDay}.Data.5km.mean.tif`  
  |||,
  license: license.id,
  ...
  extent: ee.extent_global('2001-03-01T00:00:00Z', '2023-12-31T00:00:00Z'),
  summaries: {
    gsd: [
      5000.0,
    ],
